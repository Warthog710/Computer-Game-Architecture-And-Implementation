...
public class MoveRightKeyboardAction extends AbstractInputAction 
{
    private SceneNode target;

    public MoveRightKeyboardAction(SceneNode target) 
    {
        this.target = target;
    }

    // Move right 5.0f every 1000ms or 1 second (assuming axis value = 1)
    public void performAction(float time, Event e) 
    {
        target.moveRight(-time / 200);
